...
class LeapListener extends Listener {
  ...
  private Stack<char> gesture_stack; //this stack keeps the gesture to identify potential commands for starting/stoping the program
  private Stack<char> letter_stack;
